...
aln <- readDNAMultipleAlignment( arg[2], format="fasta" )
...
# Filter and output alignment to sequences within tree. Ouput tree alignment
...
print( cat( nrow( query_md ), "tips remaining in tree\n" ) )